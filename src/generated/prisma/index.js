...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\ratta\\OneDrive\\Desktop\\ToDoList\\todo\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\ratta\\OneDrive\\Desktop\\ToDoList\\todo\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:0846554058champ@localhost:5432/todo_db"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Todo {\n  id       String   @id @default(uuid())\n  title    String\n  done     Boolean  @default(false)\n  createAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "738dfb4cedde5c6e62c7f7f6dc30865302822ea3d5e0ca46c4f3d15731e836bc",
  "copyEngine": true
}
